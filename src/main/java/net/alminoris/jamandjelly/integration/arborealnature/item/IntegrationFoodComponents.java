...
public class IntegrationFoodComponents
{
    ...
    public static final Dictionary<String, FoodComponent> JUICE_FOOD_COMPONENTS = new Hashtable<>();
    ...
    static
    {
        ...
        JAM_FOOD_COMPONENTS.put("viburnum", VIBURNUM_JAM);
        JAM_FOOD_COMPONENTS.put("white_mulberry", WHITE_MULBERRY_JAM);
        JAM_FOOD_COMPONENTS.put("wild_cherry", WILD_CHERRY_JAM);
        JAM_FOOD_COMPONENTS.put("bilberry", BILBERRY_JAM);
        JAM_FOOD_COMPONENTS.put("blackberry", BLACKBERRY_JAM);
        JAM_FOOD_COMPONENTS.put("pink_currant", PINK_CURRANT_JAM);

        JUICE_FOOD_COMPONENTS.put("quince", QUINCE_JUICE);
        JUICE_FOOD_COMPONENTS.put("plum", PLUM_JUICE);
        JUICE_FOOD_COMPONENTS.put("mango", MANGO_JUICE);
        JUICE_FOOD_COMPONENTS.put("figs", FIGS_JUICE);
        JUICE_FOOD_COMPONENTS.put("viburnum", VIBURNUM_JUICE);
        JUICE_FOOD_COMPONENTS.put("white_mulberry", WHITE_MULBERRY_JUICE);
        JUICE_FOOD_COMPONENTS.put("wild_cherry", WILD_CHERRY_JUICE);
        JUICE_FOOD_COMPONENTS.put("bilberry", BILBERRY_JUICE);
        JUICE_FOOD_COMPONENTS.put("blackberry", BLACKBERRY_JUICE);
        JUICE_FOOD_COMPONENTS.put("pink_currant", PINK_CURRANT_JUICE);
    }
}
